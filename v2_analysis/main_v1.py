...
def compute_postflop_metrics(logs):
    ...
    def hand_postflop_metrics(g):
        ...
        afq = np.divide(bets_raises, total_actions)
...
def compute_bet_sizing(logs, big_blind=BIG_BLIND):
    player_logs = logs[logs["PlayerID"].notna()].copy()
    pf_aggr = player_logs[
...
# ==============================================================================
# Plotting Function (Bar Plots vs Temperature) (Replaces Line Plots)
# ==============================================================================
def plot_metric_bars_vs_temp(
    df, metrics_to_plot, fig_title, filename=None, sharey=False
):
    if df.empty:
...
# ==============================================================================
# Main Execution Block (Updated to use bar plots)
# ==============================================================================
def main():
    ...
    try:
        ...
        print("\nComputing Metrics...")
        preflop_metrics = compute_preflop_metrics(logs)
        postflop_metrics = compute_postflop_metrics(logs)
        bet_sizing_metrics = compute_bet_sizing(logs, big_blind=BIG_BLIND)
        positional_metrics = compute_positional_metrics(logs)
